//go:generate use-codegen -type=int
//go:generate use-codegen -type=int -doc -output ../../doc/api/error_code_generated.md
...
const (
	...
	// ErrUnknown - 500: Internal server error(内部服务错误).
	ErrUnknown
